...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By Kii MD", "Dekstop", "3.0"]})
console.log(color('[ SC BY Kii MD ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : XyraBotz\n➸ Creator : Kii\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : Baruek Gilo`\n➸ My Instagram : @muhmd_zaki45\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/KiiMD\n\nThanks\n', 'red'))
